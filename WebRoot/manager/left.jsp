...
<html>
  <head>
    ...
    <script type="text/javascript">
    	function test(e){
    		//$(e) 是指e 对象
			//$(e).style.display = $(e).style.display == 'block'? 'none':'block';  //none：不显示  block 元素显示为块级元素，此元素前后会带有换行符
  ...
  <body>
	<ul>
		<li>
			<a href='javascript:void(0)' onclick="test('menu1')"> 分类管理
		...
		<br/><br/>
		<li>
			<a href='javascript:void(0)' onclick="test('menu2')"> 图书管理
				<div id="menu2" class="menu">
					<a href="${pageContext.request.contextPath }/manager/BookServlet?method=addUI" target="right">添加图书</a><br/>
					<a href="${pageContext.request.contextPath }/manager/BookServlet?method=list" target="right" >查看图书
		...
		<br/><br/>
		<li>
			<a href='javascript:void(0)' onclick="test('menu3')">订单管理
